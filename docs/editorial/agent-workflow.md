...
- 09:00 進行編集: 前日分整理、当日の対象確認、label/milestone/担当確認
...
- 16:00 進行編集: ライター成果を確認し、ビジュアル編集、校正、公開準備へ整理
- 18:00台 後工程: ビジュアル編集、校正、公開担当

ライター群は分離されたworktreeで同時実行する。後工程は同一ローカルワークスペースでの衝突を避けるため、18:00台の中で数分ずつずらして実行する。
