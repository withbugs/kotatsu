...
- sidecar metadataは `public/images/volumes/XXX/cover.json` に置き、少なくとも `source: "ai-generated"` と `usage: "volume-cover"` を含める。
- `src/content/volumes/vol-XXX.md` の `coverImage`、`coverAlt`、`visual.source`、`visual.mode`、`visual.promptSummary`、`visual.intent`、`visual.avoid` を更新する。
